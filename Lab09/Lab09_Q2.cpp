...
public:
    ...
    // 建立Max Heap
    void buildminHeap(vector<int>& arr) {  //建立Max Heap
        heap = arr;
...
int main() {
    // 從文件讀取輸入元素
    string filename = "C:/Data Structure/Lab09/input2.txt";//請貼上input檔案的正確路徑
    ...
    minHeap minHeap;// 創建Max Heap對象
    minHeap.buildminHeap(arr); // 建立Max Heap
